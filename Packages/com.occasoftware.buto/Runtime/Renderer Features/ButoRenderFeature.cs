    ...
    public class ButoRenderFeature : ScriptableRendererFeature
    {
        class RenderFogPass : ScriptableRenderPass
        {
            ...
            internal void SetupMaterials(Camera c)
            {
                ...
                Vector3Int volumeSize = volumetricFog.GetVolumeSize(new Vector2Int(c.pixelWidth, c.pixelHeight));
                ...
                if (volumeSize != storedVolumeSize || rt.lightingDataRtPrev == null || rt.mediaDataRtPrev == null)
                {
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                ...
                RenderTextureDescriptor volumeDescriptor = GetVolumeDescriptor(kvps[renderingData.cameraData.camera].volumeSize);
            ...
            private void SetupCameraProperties(CommandBuffer cmd, Camera camera)
            {
                ...
                cmd.SetGlobalVector(
                    ...
                    new Vector4(kvps[camera].volumeSize.x, kvps[camera].volumeSize.y, kvps[camera].volumeSize.z, 0)
                );
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                RenderTargetIdentifier previousMediaData = new RenderTargetIdentifier(kvps[camera].mediaDataRtPrev);
                ...
                // Lighting write
                RenderTargetIdentifier previousLightingData = new RenderTargetIdentifier(kvps[camera].lightingDataRtPrev);
            ...
            private void SetupMaterialData(CommandBuffer cmd, Camera cam)
            {
                ...
                float inverseMaxDistance = Mathf.Max(1.0f / volumetricFog.maxDistanceVolumetric.value, 1e-7f);
                ...
                cmd.SetGlobalFloat("buto_TemporalIntegration_Lighting", GetIntegrationAmount(volumetricFog.temporalAALighting.value, cam));
                cmd.SetGlobalFloat("buto_TemporalIntegration_Media", GetIntegrationAmount(volumetricFog.temporalAAMedia.value, cam));
                ...
                cmd.SetGlobalFloat(Params._InverseNoiseScale.Id, Mathf.Max(1.0f / volumetricFog.noiseTiling.value, 1e-7f));
                cmd.SetGlobalFloat(Params._Inverse_AttenuationBoundarySize.Id, Mathf.Max(1.0f / volumetricFog.attenuationBoundarySize.value, 1e-7f));
