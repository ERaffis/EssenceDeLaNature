...
Shader "Distant Lands/Cozy/Stylized Clouds Soft"
{
	Properties
	{
		...
		[HDR]_CloudThickness("CloudThickness", Range( 0 , 4)) = 1
	...
	SubShader
	{
		...
		uniform float _BorderHeight;
		uniform float _BorderVariation;
		uniform float _BorderEffect;
		uniform float3 _StormDirection;
		uniform float _NimbusHeight;
		uniform float _NimbusMultiplier;
		uniform float _NimbusVariation;
		uniform sampler2D _ChemtrailsTexture;
		uniform float _ChemtrailsMoveSpeed;
		uniform float _ChemtrailsMultiplier;
		uniform sampler2D _CirrusTexture;
		uniform float _CirrusMoveSpeed;
		uniform float _CirrusMultiplier;
		uniform half _CloudFlareFalloff;
		uniform float4 _AltoCloudColor;
		uniform float _AltocumulusScale;
		uniform float2 _AltocumulusWindSpeed;
		uniform float _AltocumulusMultiplier;
		uniform sampler2D _CirrostratusTexture;
		uniform float _CirrostratusMoveSpeed;
		uniform float _CirrostratusMultiplier;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float3 normalizeResult779 = normalize( ( ase_worldPos - _WorldSpaceCameraPos ) );
			...
			float2 temp_output_726_0 = ( i.uv_texcoord - float2( 0.5,0.5 ) );
			...
			float mulTime566 = _Time.y * 0.01;
			float simplePerlin2D563 = snoise( (Pos159*1.0 + mulTime566)*2.0 );
			float mulTime560 = _Time.y * _ChemtrailsMoveSpeed;
			...
			float2 temp_output_581_0 = ( i.uv_texcoord - float2( 0.5,0.5 ) );
			...
			float mulTime673 = _Time.y * 0.01;
			float simplePerlin2D681 = snoise( (Pos159*1.0 + mulTime673)*2.0 );
			float mulTime666 = _Time.y * _CirrusMoveSpeed;
			...
			float2 temp_output_690_0 = ( i.uv_texcoord - float2( 0.5,0.5 ) );
			...
			float mulTime602 = _Time.y * 0.003;
			...
			float2 coords492 = i.uv_texcoord * 10.0;
			float2 id492 = 0;
			float2 uv492 = 0;
			...
			float mulTime611 = _Time.y * 0.01;
			float simplePerlin2D620 = snoise( (Pos159*1.0 + mulTime611)*2.0 );
			float mulTime607 = _Time.y * _CirrostratusMoveSpeed;
			...
			float2 temp_output_629_0 = ( i.uv_texcoord - float2( 0.5,0.5 ) );
			...
			o.Emission = FinalCloudColor351.rgb;
			...
			o.Alpha = saturate( ( FinalAlpha408.r + ( FinalAlpha408.r * 2.0 * _CloudThickness ) ) );
		}
...
Node;AmplifyShaderEditor.Vector3Node;260;-3865.421,-3964.893;Inherit;False;Global;CZY_SunDirection;CZY_SunDirection;6;1;[HideInInspector];Create;True;0;0;0;False;0;False;0,0,0;-0.7923148,0.4805301,0.3759362;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;778;-3888.292,-3647.702;Inherit;False;Global;CZY_MoonDirection;CZY_MoonDirection;7;1;[HideInInspector];Create;True;0;0;0;False;0;False;0,0,0;0,-0.6293204,0.777146;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.GetLocalVarNode;799;-1456,-496;Inherit;False;408;FinalAlpha;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;804;-1280,-496;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.RangedFloatNode;801;-1424,-351;Inherit;False;Property;_CloudThickness;CloudThickness;33;1;[HDR];Create;True;0;0;0;False;0;False;1;1;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;352;-948.2714,-629.483;Inherit;False;351;FinalCloudColor;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-678.2959,-671.1561;Float;False;True;-1;2;EmptyShaderGUI;0;0;Unlit;Distant Lands/Cozy/Stylized Clouds Soft;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Front;0;False;;0;False;;False;0;False;;0;False;;False;0;Transparent;0.5;True;True;-50;False;Transparent;;Transparent;ForwardOnly;12;all;True;True;True;True;0;False;;True;221;False;;255;False;;255;False;;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;2;5;False;;10;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;0;2;352;0
WireConnection;0;9;802;0
ASEEND*/
//CHKSM=E0F6367A9E558EDFFF7BD547E7A0BCC6546CB1B0