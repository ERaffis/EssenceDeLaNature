...
//=============================================================================
inline void CoverVertexUV ( in float2 i_worldUVScale, in float4 i_vertex, in float4x4 objToWorld, inout float2 i_coverLayer0UV,inout float2 i_coverLayer1UV )
{
#if defined(_PW_SF_COVER_ON)
	float4 worldPosition = mul(objToWorld, i_vertex);
/*#ifdef _PW_HDRP_ON
...
//=============================================================================
inline void WorldMapUV ( in half2 i_worldUVScale, in half i_worldMapUVScale, in float4x4 i_objToWorld, out half2 o_uv )
{
	half4 worldPosition = mul(i_objToWorld, float4(0, 0, 0, 1));
...
//=============================================================================
inline void CalculateThicknessHDRP_float(
                       in float4 i_coverRGBA,
