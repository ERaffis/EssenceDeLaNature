...
namespace Gaia
{
    ...
    public class SceneProfile : ScriptableObject
    {
        ...
        public float m_extraWaterRenderDistance = 0f;
        ...
        //HDRP
        public bool m_reflectShadowsHDRP = false;
        public bool m_roughReflectionsHDRP = false;
        ...
        public void SaveTerrainLoaderToProfile(TerrainLoader tl)
        {
            if (GaiaUtils.HasDynamicLoadedTerrains())
            {
                if (tl != null)
                {
                    m_terrainLoaderLoadMode = tl.LoadMode;
                    m_terrainLoaderMinRefreshDistance = tl.m_minRefreshDistance;
                    m_terrainLoaderMaxRefreshDistance = tl.m_maxRefreshDistance;
                    m_terrainLoaderMinRefreshMS = tl.m_minRefreshMS;
                    m_terrainLoaderMaxRefreshMS = tl.m_maxRefreshMS;
                    m_terrainLoaderFollowTransform = tl.m_followTransform;
                    m_terrainLoaderLoadingBoundsRegular = tl.m_loadingBoundsRegular;
                    m_terrainLoaderLoadingBoundsImpostor = tl.m_loadingBoundsImpostor;
                    m_terrainLoaderLoadingBoundsCollider = tl.m_loadingBoundsCollider;
                }
            }
        }
#endif
