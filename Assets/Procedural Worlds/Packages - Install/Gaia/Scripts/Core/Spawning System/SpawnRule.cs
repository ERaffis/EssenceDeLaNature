...
namespace Gaia
{
    ...
    public class SpawnRule
    {
        ...
        /// <summary>
        /// unique id that is independent of name, position in spawner, etc. for identifying a rule.
        /// </summary>
        [SerializeField]
        private string m_guid;
        public string GUID { get { return m_guid; } }
        public bool m_useExtendedSpawn = false;
        public float m_minRequiredFitness = 0.25f;
        public float m_minInstanceRequiredFitness = 0f;
        ...
        //The min 'step size' the spawner uses when traveling across the terrain to determine spawn locations. The spawner will choose the min step size for areas with strong strength in the visualisation, and vice versa.
        public float m_locationIncrementMin = 25f;
        //The max 'step size' the spawner uses when traveling across the terrain to determine spawn locations. The spawner will choose the min step size for areas with strong strength in the visualisation, and vice versa.
        public float m_locationIncrementMax = 45f;

        //The spawner will add a random percentage to the location increment to make the placement more natural. 0 = grid-like placement, 1 = unordered placement
        public float m_jitterPercent = 1.0f;

        /// The higher this value is, the more data points are being checked to determine whether the bounds within this object spawn are good for spawning
        public float m_boundsCheckQuality = 25f;
        ...
        //The preview color used in the spawner preview to represent this spawn rule
        ...
        /// Our noise generator
        /// </summary>
        private Gaia.FractalGenerator m_noiseGenerator = null;
        ...
        public GaiaConstants.SpawnerTargetMode m_goSpawnTargetMode = GaiaConstants.SpawnerTargetMode.Terrain;
        public Transform m_goSpawnTarget;
        public string m_terrainGOSpawnTargetName = GaiaConstants.defaultGOSpawnTarget;
        public int m_terrainDetailDensity = 15;
        public float m_terrainDetailMinFitness = 0.5f;
        public float m_terrainDetailFitnessBeginFadeOut = 0.6f;
        public BiomeController m_createdBiomeController;
        public bool m_visibleInSceneHierarchy=true;
        ...
        public void Initialise(Spawner spawner)
        {
            ...
            if (spawner.m_settings.m_resources.ResourceIdxOutOfBounds(m_resourceType, m_resourceIdx))
            {
            ...
            if (!spawner.m_settings.m_resources.ResourceIsInUnity(m_resourceType, m_resourceIdx))
            {
            ...
            m_resourceIdxPhysical = spawner.m_settings.m_resources.PrototypeIdxInTerrain(m_resourceType, m_resourceIdx);
            ...
            //if (m_resourceType == GaiaConstants.SpawnerResourceType.GameObject)
            //{
            //    if (spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx].m_dna.m_extParam.ToLower().Contains("nograss"))
            //    {
            ...
            //{
            //    if (spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx].m_dna.m_extParam.ToLower().Contains("nograss"))
            //    {
            //        m_colliderName = "_GaiaCollider_NoGrass";
            //    }
            //    else
            ...
            //        {
            //            extensions = spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].m_spawnExtensions;
            //            break;
            //        }
            //    case GaiaConstants.SpawnerResourceType.TerrainTexture:
            //        {
            //            //extensions = spawner.m_settings.m_resources.m_texturePrototypes[m_resourceIdx].m_spawnExtensions;
            //            break;
            //        }
            //    case GaiaConstants.SpawnerResourceType.TerrainTree:
            //        {
            //            extensions = spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx].m_spawnExtensions;
            //            break;
            //        }
            //    case GaiaConstants.SpawnerResourceType.GameObject:
            //        {
            //            extensions = spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx].m_spawnExtensions;
            //            break;
            //        }
            //}
        ...
        {
            m_resourceIdxPhysical = spawner.m_settings.m_resources.PrototypeIdxInTerrain(m_resourceType, m_resourceIdx, terrain);
            if (m_resourceIdxPhysical < 0)
            {
                return false;
            }
        ...
        /// </summary>
        /// <param name="spawner">Spawner we belong to</param>
        public void AddResourceToTerrain(Spawner spawner, Terrain[] terrains = null)
        {
            spawner.m_settings.m_resources.AddPrototypeToTerrain(m_resourceType, m_resourceIdx, terrains);
        }
        ...
        public float GetFitness(ref SpawnInfo spawnInfo)
        {
            ...
            switch (m_resourceType)
            {
                case GaiaConstants.SpawnerResourceType.TerrainDetail:
                    {
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].m_spawnCriteria;
                        extensions = spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].m_spawnExtensions;
                        break;
                    }
                case GaiaConstants.SpawnerResourceType.TerrainTexture:
                    {
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_texturePrototypes[m_resourceIdx].m_spawnCriteria;
                        //extensions = spawnInfo.m_spawner.m_settings.m_resources.m_texturePrototypes[m_resourceIdx].m_spawnExtensions;
                        break;
                    }
                case GaiaConstants.SpawnerResourceType.TerrainTree:
                    {
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx].m_spawnCriteria;
                        extensions = spawnInfo.m_spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx].m_spawnExtensions;
                        break;
                    }
                case GaiaConstants.SpawnerResourceType.GameObject:
                    {
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx].m_spawnCriteria;
                        extensions = spawnInfo.m_spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx].m_spawnExtensions;
                        break;
                    }
                    /*
                default:
                    {
                        filters = spawnInfo.m_spawner.m_settings.m_resources.m_stampPrototypes[m_resourceIdx].m_spawnCriteria;
                        break;
                    }
                     */
            }
        ...
        //        case GaiaConstants.SpawnerResourceType.TerrainDetail:
        //            {
        //                return spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].m_dna.m_boundsRadius;
        //            }
        //        case GaiaConstants.SpawnerResourceType.TerrainTree:
        //            {
        //                return spawnInfo.m_spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx].m_dna.m_boundsRadius;
        //            }
        //        case GaiaConstants.SpawnerResourceType.GameObject:
        //            {
        //                return spawnInfo.m_spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx].m_dna.m_boundsRadius;
        //            }
        //            /*
        //        default:
        //            {
        //                return spawnInfo.m_spawner.m_settings.m_resources.m_stampPrototypes[m_resourceIdx].m_dna.m_boundsRadius;
        //            }
        //             */
        //    }
        //    return 0f;
        ...
        public float GetMaxScaledRadius(ref SpawnInfo spawnInfo)
        {
            ...
            //    case GaiaConstants.SpawnerResourceType.TerrainDetail:
            //        {
            //            return spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].m_dna.m_boundsRadius * spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].m_dna.m_maxScale;
            //        }
            //    case GaiaConstants.SpawnerResourceType.TerrainTree:
            //        {
            //            return spawnInfo.m_spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx].m_dna.m_boundsRadius * spawnInfo.m_spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx].m_dna.m_maxScale;
            //        }
            //    case GaiaConstants.SpawnerResourceType.GameObject:
            //        {
            //            return spawnInfo.m_spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx].m_dna.m_boundsRadius * spawnInfo.m_spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx].m_dna.m_maxScale;
            //        }
            //        /*
            //    default:
            //        {
            //            return spawnInfo.m_spawner.m_settings.m_resources.m_stampPrototypes[m_resourceIdx].m_dna.m_boundsRadius * spawnInfo.m_spawner.m_settings.m_resources.m_stampPrototypes[m_resourceIdx].m_dna.m_maxScale;
            //        } */
            //}
            return 0f;
        }
        ...
        //        case GaiaConstants.SpawnerResourceType.TerrainDetail:
        //            {
        //                return spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].m_dna.m_seedThrow;
        //            }
        //        case GaiaConstants.SpawnerResourceType.TerrainTree:
        //            {
        //                return spawnInfo.m_spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx].m_dna.m_seedThrow;
        //            }
        //        case GaiaConstants.SpawnerResourceType.GameObject:
        //            {
        //                return spawnInfo.m_spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx].m_dna.m_seedThrow;
        //            }
        //            /*
        //        default:
        //            {
        //                return spawnInfo.m_spawner.m_settings.m_resources.m_stampPrototypes[m_resourceIdx].m_dna.m_seedThrow;
        //            }
        //             */
        //    }
        //    return 0f;
        ...
        public void Spawn(ref SpawnInfo spawnInfo)
        {
            ...
            //                int newStrength = 1;
            //                if (spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].m_dna.m_rndScaleInfluence == true)
            //                {
            //                    newStrength = (int)Mathf.Clamp(15f * spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].m_dna.GetScale(spawnInfo.m_fitness, spawnInfo.m_spawner.GetRandomFloat(0f, 1f)), 1f, 15f);
            //                }
            //                else
            //                {
            //                    newStrength = (int)Mathf.Clamp(15f * spawnInfo.m_spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].m_dna.GetScale(spawnInfo.m_fitness), 1f, 15f);
            //                }
            ...
            //        case GaiaConstants.SpawnerResourceType.TerrainTree:
            //            {
            //                ResourceProtoTree treeProto = spawnInfo.m_spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx];
            ...
            //        case GaiaConstants.SpawnerResourceType.GameObject:
            //            {
            //                ResourceProtoGameObject gameProto = spawnInfo.m_spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx];
            //                float scale = 1f;
            //                float localScale = 1f;
            //                float localDist = 0f;
                ...
                case GaiaConstants.SpawnerResourceType.TerrainDetail:
                    ...
                    switch (detailProto.m_renderMode)
                    {
                        ...
                        case DetailRenderMode.GrassBillboard:
                            return detailProto.m_detailTexture == null;
                        case DetailRenderMode.Grass:
                            return detailProto.m_detailTexture == null && detailProto.m_detailProtoype == null; 
                        default:
                            return detailProto.m_detailTexture == null;
                    }
                case GaiaConstants.SpawnerResourceType.TerrainTree:
                    return spawnerSettings.m_resources.m_treePrototypes[m_resourceIdx].m_desktopPrefab == null;
                case GaiaConstants.SpawnerResourceType.GameObject:
                    return spawnerSettings.m_resources.m_gameObjectPrototypes[m_resourceIdx].m_instances.Length<=0 || spawnerSettings.m_resources.m_gameObjectPrototypes[m_resourceIdx].m_instances.Where(x=>x.m_desktopPrefab==null).Count()>0;
                case GaiaConstants.SpawnerResourceType.SpawnExtension:
                    //Multiple conditions for a valid Spawn extension resource:
                    //-Must contain instances
                    //-Instances must contain prefabs
                    //-Prefabs must contain a valid Spawn Extension implementation
                    return spawnerSettings.m_resources.m_spawnExtensionPrototypes[m_resourceIdx].m_instances.Length <= 0 || 
                        spawnerSettings.m_resources.m_spawnExtensionPrototypes[m_resourceIdx].m_instances.Where(x => x.m_spawnerPrefab == null).Count() > 0 ||
                        spawnerSettings.m_resources.m_spawnExtensionPrototypes[m_resourceIdx].m_instances.Where(x => x.m_invalidPrefabSupplied == true).Count() > 0;
                case GaiaConstants.SpawnerResourceType.StampDistribution:
                    return false;
                case GaiaConstants.SpawnerResourceType.TerrainModifierStamp:
                    //No real, "checkable" prototype resource for terrain modifier stamps, just data that is stored in the resource
                    return false;
                case GaiaConstants.SpawnerResourceType.Probe:
                    //No Prototypes for probes, will be generated from scratch
                    return false;
            }
            return true;
        }
                ...
                case GaiaConstants.SpawnerResourceType.TerrainTexture:
                    {
                        ...
                        //    }
                        //}
                        return spawner.m_settings.m_resources.m_texturePrototypes[m_resourceIdx].ChecksTextures();
                    }
                case GaiaConstants.SpawnerResourceType.TerrainDetail:
                    {
                        extensions = spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].m_spawnExtensions;
                        ...
                        return spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].ChecksTextures();
                    }
                case GaiaConstants.SpawnerResourceType.TerrainTree:
                    {
                        extensions = spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx].m_spawnExtensions;
                        ...
                        return spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx].ChecksTextures();
                    }
                case GaiaConstants.SpawnerResourceType.GameObject:
                    {
                        extensions = spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx].m_spawnExtensions;
                        ...
                        return spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx].ChecksTextures();
                    }
                    /*
                case Constants.SpawnerResourceType.Stamp:
                    {
                        return spawner.m_settings.m_resources.m_stampPrototypes[m_resourceIdx].ChecksTextures();
                    } */
            }
        ...
        public bool CacheProximity(Spawner spawner)
        {
            ...
            switch (m_resourceType)
            {
                case GaiaConstants.SpawnerResourceType.TerrainTexture:
                    {
                        return spawner.m_settings.m_resources.m_texturePrototypes[m_resourceIdx].ChecksProximity();
                    }
                case GaiaConstants.SpawnerResourceType.TerrainDetail:
                    {
                        return spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].ChecksProximity();
                    }
                case GaiaConstants.SpawnerResourceType.TerrainTree:
                    {
                        return spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx].ChecksProximity();
                    }
                case GaiaConstants.SpawnerResourceType.GameObject:
                    {
                        return spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx].ChecksProximity();
                    }
                    /*
                case Constants.SpawnerResourceType.Stamp:
                    {
                        return spawner.m_settings.m_resources.m_stampPrototypes[m_resourceIdx].ChecksProximity();
                    }
                     */
            }
        ...
        public void AddProximityTags(Spawner spawner, ref List<string> tagList)
        {
            ...
            switch (m_resourceType)
            {
                case GaiaConstants.SpawnerResourceType.TerrainTexture:
                    {
                        spawner.m_settings.m_resources.m_texturePrototypes[m_resourceIdx].AddTags(ref tagList);
                        break;
                    }
                case GaiaConstants.SpawnerResourceType.TerrainDetail:
                    {
                        spawner.m_settings.m_resources.m_detailPrototypes[m_resourceIdx].AddTags(ref tagList);
                        break;
                    }
                case GaiaConstants.SpawnerResourceType.TerrainTree:
                    {
                        spawner.m_settings.m_resources.m_treePrototypes[m_resourceIdx].AddTags(ref tagList);
                        break;
                    }
                case GaiaConstants.SpawnerResourceType.GameObject:
                    {
                        spawner.m_settings.m_resources.m_gameObjectPrototypes[m_resourceIdx].AddTags(ref tagList);
                        break;
                    }
                    /*
                case Constants.SpawnerResourceType.Stamp:
                    {
                        spawner.m_settings.m_resources.m_stampPrototypes[m_resourceIdx].AddTags(ref tagList);
                        break;
                    } */
            }
        }
        ...
        public void AddStamps(Spawner spawner, ref List<string> stampList)
        {
            ...
            if (m_resourceType == Constants.SpawnerResourceType.Stamp)
            {
                spawner.m_settings.m_resources.m_stampPrototypes[m_resourceIdx].AddStamps(ref stampList);
            }
        }
        */
    }
