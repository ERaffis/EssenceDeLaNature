...
namespace Gaia
{
    ...
    public class GaiaSettings : ScriptableObject
    {
        ...
        public bool m_instantiateCustomControllers = false;
        [Tooltip("Target size.")]
        ...
        [Tooltip("Disable Warning Message")]
        public bool m_disableTerrainModifierWarning = false;
        [Tooltip("The Index of the renderer used on the Orthographic Bake camera in URP (used for e.g. Collision Mask Baking)")]
        public int m_URPOrthoBakeRendererIndex = 0;


        [Header("World Designer")]
        [Tooltip("The maximum amount of stamps that can be previewed in the world designer at the same time.")]
        public int m_maxWorldDesignerPreviewStamps = 100;
        [Tooltip("The first sample object to be shown on the world map to evaluate the scale.")]
        public Mesh m_worldDesignerSampleObjectMesh1;
        [Tooltip("The second sample object to be shown on the world map to evaluate the scale.")]
        public Mesh m_worldDesignerSampleObjectMesh2;
        [Tooltip("The third sample object to be shown on the world map to evaluate the scale.")]
