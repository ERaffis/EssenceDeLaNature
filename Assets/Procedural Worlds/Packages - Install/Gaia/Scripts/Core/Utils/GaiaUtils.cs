...
namespace Gaia
{
    ...
    public enum GaiaPackageVersion { Unity2019_1, Unity2019_2, Unity2019_3, Unity2019_4, Unity2020_1, Unity2020_2, Unity2020_3, Unity2020_4, Unity2021_1, Unity2021_2, Unity2021_3, Unity2021_4, Unity2022_1, Unity2022_2, Unity2022_3, Unity2022_4, Unity2023_1, Unity2023_2, Unity2023_3, Unity2024_1, Unity2024_2, Unity2024_3 }
...
#region Programming helpers
        ...
        public static List<Type> GetInheritedTypes<T>() where T : class
        {
            ...
            Assembly[] assemblies = AppDomain.CurrentDomain.GetAssemblies().Where(x => x.FullName.Contains("Assembly-CSharp") || x.FullName.Contains("GaiaCore")).ToArray();
        ...
        public static GaiaPackageVersion GetPackageVersion()
        {
            ...
            else if (Application.unityVersion.Contains("2023.3"))
            {
                return GaiaPackageVersion.Unity2023_3;
            }
            else if (Application.unityVersion.Contains("2024.1"))
            {
                return GaiaPackageVersion.Unity2024_1;
            }
            else if (Application.unityVersion.Contains("2024.2"))
            {
                return GaiaPackageVersion.Unity2024_2;
            }
            else if (Application.unityVersion.Contains("2024.3"))
            {
                return GaiaPackageVersion.Unity2024_3;
            }
