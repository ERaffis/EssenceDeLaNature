...
namespace Gaia
{
    public static class GaiaConstants
    {
        ...
        public static readonly string HDRPPostProcessingObject = "HD Post Processing Environment Volume";
        public static readonly string HDRPWorldDensityObject = "Gaia World Density Volume";
        ...
        /// <summary>
        /// Name of the Game Object that holds the Gaia Lighting.
        /// </summary>
        public static string gaiaLightingObject = "Gaia Lighting";


        /// <summary>
        /// Name of the PW Sky object for the Procedural Worlds Sky.
        /// </summary>
        public static string pwSkyObject = "PW Sky";
