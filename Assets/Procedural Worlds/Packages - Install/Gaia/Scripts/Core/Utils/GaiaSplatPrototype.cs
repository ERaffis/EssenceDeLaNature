    ...
    public struct GaiaSplatPrototype
    {
        ...
        public GaiaSplatPrototype(TerrainLayer terrainLayer)
        {
            ...
            if (terrainLayer != null)
            {
                ...
                maskMap = terrainLayer.maskMapTexture;
                ...
                diffuseRemapMin = terrainLayer.diffuseRemapMin;
                diffuseRemapMax = terrainLayer.diffuseRemapMax;
                maskMapRemapMin = terrainLayer.maskMapRemapMin;
                maskMapRemapMax = terrainLayer.maskMapRemapMax;
                specularColor = terrainLayer.specular;
            }
        }
        ...
        public static void SetGaiaSplatPrototypes(Terrain terrain, GaiaSplatPrototype[] splats, string terrainName)
        {
            ...
            {
                terrain.terrainData.terrainLayers = CreateTerrainLayers(terrain.name, splats);
            }
        }
