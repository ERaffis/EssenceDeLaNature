...
namespace Gaia
{
    ...
    public class ReflectionMaskerData
    {
        ...
        public void SetState(SceneProfile profile, bool state)
        {
            ...
            {
                m_planarReflections = GameObject.FindAnyObjectByType<GaiaPlanarReflections>();
                if (m_planarReflections != null)
                {
                    m_planarReflections.SetReflectionState(state);
                }
            ...
            {
                m_planarReflectionsHDRP = GameObject.FindAnyObjectByType<GaiaPlanarReflectionsHDRP>();
                if (m_planarReflectionsHDRP != null)
                {
                    m_planarReflectionsHDRP.SetReflectionState(state);
                }
