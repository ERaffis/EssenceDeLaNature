...
namespace Gaia
{
    ...
    public class GaiaSessionManager : MonoBehaviour
    {
        ...
        GameObject FindOrCreateObject(GaiaOperation operation)
        {
            ...
            //    Stamper[] stampers = GameObject.FindObjectsByType<Stamper>();
            ...
            //{
            //    //See if we can locate it in the existing stamps
            //    Spawner[] spawners = GameObject.FindObjectsByType<Spawner>();
        ...
        private static GameObject CreateTile(int tx, int tz, WorldCreationSettings worldCreationSettings, ref Terrain[,] world, TerrainLayer[] terrainLayers, DetailPrototype[] terrainDetails, TreePrototype[] terrainTrees)
        {
            ...
            if (detailOverwrite == null)
            {
                ...
                detailOverwrite.m_unityDetailDistance = gaiaDefaults.m_detailDistance;
                detailOverwrite.m_unityDetailDensity = gaiaDefaults.m_detailDensity;
                detailOverwrite.m_gaiaDetailDistance = Mathf.Max(0f, detailOverwrite.m_unityDetailDistance - 30);
                detailOverwrite.m_gaiaDetailFadeoutDistance = detailOverwrite.m_gaiaDetailDistance * 0.1f;
                GaiaUtils.SetTerrainDetailShaderDistances(detailOverwrite.m_gaiaDetailDistance, detailOverwrite.m_gaiaDetailFadeoutDistance);
