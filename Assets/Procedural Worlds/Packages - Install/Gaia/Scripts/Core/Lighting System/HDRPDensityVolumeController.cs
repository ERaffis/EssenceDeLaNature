...
#region Utils
        ...
        private LocalVolumetricFog CreateOrGetVolume()
        {
            ...
            LocalVolumetricFog volume = FindAnyObjectByType<LocalVolumetricFog>();
        ...
        private void GetDensityVolumes()
        {
            ...
            HDRPDensityVolumeComponent[] volumes = FindObjectsByType<HDRPDensityVolumeComponent>(FindObjectsSortMode.None);
            if (volumes.Length > 1)
            {
...
#region Public Static Functions
        ...
        public static void RemoveGaiaHDRPDensityVolume()
        {
            ...
            {
                HDRPDensityVolumeController densityVolume = FindAnyObjectByType<HDRPDensityVolumeController>();
