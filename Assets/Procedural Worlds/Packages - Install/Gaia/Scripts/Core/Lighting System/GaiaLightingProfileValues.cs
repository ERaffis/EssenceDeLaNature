...
namespace Gaia
{
    ...
    public class GaiaLightingProfileValues
    {
        ...
        //HDRP
        public bool m_useGlobalIllumination = true;
        [Header("Denisty Volume Settings")]
        #if HDPipeline
        public bool m_useDensityVolumeSystem = true;
        public DensityVolumeResolution m_densityVolumeResolution = DensityVolumeResolution.High;
        public Vector3 m_customDensityVolumeResolution = new Vector3(512f, 512f, 512f);
        public DensityVolumeEffectType m_densityVolumeEffectType = DensityVolumeEffectType.LightHase;
        public Vector3 m_customDensityVolumeEffectType = new Vector3(15f, 15f, 15f);
        #endif
