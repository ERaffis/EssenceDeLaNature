...
#pragma warning restore 414
        ...
        private static void OnScriptsReloaded()
        {
            ...
            foreach (var obj in GameObject.FindObjectsByType<Stamper>(FindObjectsSortMode.None))
            {
        ...
        public void DrawStampPreview(List<StamperSettings> worldMapStamperSettings = null, bool isWorldMapPreview = false)
        {
            ...
            //Can happen if the stamper is deleted and this function still triggers afterwards
            if (this == null || transform == null || m_settings == null)
            {
                return;
            }
