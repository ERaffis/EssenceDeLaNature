...
#region Gaia Weather
            ...
            public static bool GetGaiaWindSettings(out float windSpeed, out float windDirection, out bool overrideWind)
        {
            ...
            {
                WindZone windZone = GameObject.FindAnyObjectByType<WindZone>();
                if (windZone != null)
                {
...
#region Gaia Water Setup
        ...
        public static void SetWaterReflections(bool enabled)
        {
            if (GaiaUtils.CheckIfSceneProfileExists())
            {
                ...
                if (GaiaUtils.GetActivePipeline() == GaiaConstants.EnvironmentRenderer.HighDefinition)
                {
                    GaiaPlanarReflectionsHDRP hdrpReflection = GameObject.FindAnyObjectByType<GaiaPlanarReflectionsHDRP>();
...
#region HDRP
        ...
        public static int GetHDRPWaterResolutionQuality(GaiaPlanarReflectionsHDRP planarProbe = null)
        {
            if (planarProbe == null)
            {
                planarProbe = GameObject.FindAnyObjectByType<GaiaPlanarReflectionsHDRP>();
                if (planarProbe != null)
                {
        ...
        public static GaiaPlanarReflectionsHDRP GetGaiaOceanPlanarReflections()
        {
            ...
            if (water != null)
            {
                GaiaPlanarReflectionsHDRP hdrpPlanar = GameObject.FindAnyObjectByType<GaiaPlanarReflectionsHDRP>();
                if (hdrpPlanar != null)
                {
                    return hdrpPlanar;
                }
...
#region Runtime
        ...
        public static void SetCameraRoll(float value, Camera camera = null)
        {
            if (camera == null)
            {
                ...
                FreeCamera freeCamera = GameObject.FindAnyObjectByType<FreeCamera>();
                if (freeCamera != null)
                {
...
#if GAIA_INPUT_SYSTEM
        public static void GetPhotoModeSettings(out bool loadSavedSettings, out bool revertOnDisabled, out bool showreticule, out bool showRuleOfThirds, out Key showPhotoMode)
        {
            loadSavedSettings = true;
            revertOnDisabled = true;
            showreticule = false;
            showRuleOfThirds = false;
            showPhotoMode = Key.F11;
...
/// <param name="showPhotoMode"></param>
#if GAIA_INPUT_SYSTEM
        public static void SetPhotoModeSettings(bool loadSavedSettings, bool revertOnDisabled, bool showreticule, bool showRuleOfThirds, Key showPhotoMode)
        {
            UIConfiguration ui = UIConfiguration.Instance;
            if (ui != null)
            {
        ...
        public static void SetRuntimePlayerAndCamera(GameObject player, Camera camera)
        {
            ...
            GaiaUtils.SetUpGaiaCharacter(player);
        }
        /// <summary>
