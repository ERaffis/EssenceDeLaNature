...
namespace Gaia
{
    public class LocationManagerEditor : EditorWindow, IPWEditor
    {
        ...
        private void RuntimeControls(bool helpEnabled)
        {
            ...
            {
#if GAIA_INPUT_SYSTEM
                m_profile.m_locationProfile.m_mainKey = (Key)m_editorUtils.EnumPopup("MasterKey", m_profile.m_locationProfile.m_mainKey, helpEnabled);
                m_profile.m_locationProfile.m_addBookmarkKey = (Key)m_editorUtils.EnumPopup("AddNewBookmark", m_profile.m_locationProfile.m_addBookmarkKey, helpEnabled);
                m_profile.m_locationProfile.m_prevBookmark = (Key)m_editorUtils.EnumPopup("PreviousBookmark", m_profile.m_locationProfile.m_prevBookmark, helpEnabled);
                m_profile.m_locationProfile.m_nextBookmark = (Key)m_editorUtils.EnumPopup("NextBookmark", m_profile.m_locationProfile.m_nextBookmark, helpEnabled);
#endif
            }
            else
            {
        ...
        {
            LocationSystem locationSystem = FindAnyObjectByType<LocationSystem>();
        ...
        {
            LocationSystem system = GameObject.FindAnyObjectByType<LocationSystem>();
            if (system != null)
            {
