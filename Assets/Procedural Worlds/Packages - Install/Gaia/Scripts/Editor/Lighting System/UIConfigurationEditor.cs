...
namespace Gaia
{
    ...
    public class UIConfigurationEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
...
#if GAIA_INPUT_SYSTEM
            m_ui.m_uiToggleButton = (Key)EditorGUILayout.EnumPopup(new GUIContent("UI Toggle Key", "When this key is pressed it will hide or show the UI text."), m_ui.m_uiToggleButton);
#endif
            ...
            m_ui.m_uiToggleText = (Text)EditorGUILayout.ObjectField("UI Toggle Text", m_ui.m_uiToggleText, typeof(Text), true);
            m_ui.m_controlsText = (Text)EditorGUILayout.ObjectField("Controls Text", m_ui.m_controlsText, typeof(Text), true);
            ...
            m_ui.m_screenShotterText = (Text)EditorGUILayout.ObjectField("Screen Shotter Text", m_ui.m_screenShotterText, typeof(Text), true);
            ...
            EditorGUI.indentLevel++;
#if GAIA_INPUT_SYSTEM
            m_ui.m_showPauseMenu = (Key)EditorGUILayout.EnumPopup(new GUIContent("Show Pause Menu", "When this key is pressed it will hide or show the pause menu."), m_ui.m_showPauseMenu);
#endif
