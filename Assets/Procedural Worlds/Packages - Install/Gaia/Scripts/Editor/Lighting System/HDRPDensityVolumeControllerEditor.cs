    ...
    public class HDRPDensityVolumeControllerEditor : PWEditor
    {
        ...
        private void GlobalSettingsPanel(bool helpEnabled)
        {
            if (m_profile != null)
            {
                ...
                m_profile.DensityVolumeProfile.m_distanceFadeEnd = m_editorUtils.FloatField("DistanceFadeEnd", m_profile.DensityVolumeProfile.m_distanceFadeEnd, helpEnabled);
                EditorGUILayout.Space();
