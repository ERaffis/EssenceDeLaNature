    ...
    public class GaiaGlobalEditor : PWEditor
    {
        ...
        private void GlobalSettingsPanel(bool helpEnabled)
        {
            ...
            if (m_profile.SceneProfile != null)
            {
                ...
                GaiaConstants.GlobalSystemMode lightMode = m_profile.SceneProfile.m_lightSystemMode;
                lightMode = (GaiaConstants.GlobalSystemMode)m_editorUtils.EnumPopup("LightingSystemMode", lightMode);
                if (lightMode != m_profile.SceneProfile.m_lightSystemMode)
                {
                    m_profile.SceneProfile.m_lightSystemMode = lightMode;
                    GaiaLighting.GetProfile(GaiaGlobal.Instance.SceneProfile, m_gaiaSettings.m_pipelineProfile, m_gaiaSettings.m_pipelineProfile.m_activePipelineInstalled, true);
                }
                ...
                GaiaConstants.GlobalSystemMode waterMode = m_profile.SceneProfile.m_waterSystemMode;
                waterMode = (GaiaConstants.GlobalSystemMode)m_editorUtils.EnumPopup("WaterSystemMode", waterMode);
                if (m_profile.SceneProfile.m_waterSystemMode != waterMode)
                {
                    m_profile.SceneProfile.m_waterSystemMode = waterMode;
                    GaiaWater.GetProfile(m_profile.SceneProfile.m_selectedWaterProfileValuesIndex, GaiaGlobal.Instance.SceneProfile, true, false);
                }
