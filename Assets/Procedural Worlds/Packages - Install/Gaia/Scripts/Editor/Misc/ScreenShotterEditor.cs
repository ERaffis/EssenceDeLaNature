...
namespace Gaia
{
    ...
    public class ScreenShotterEditor : PWEditor
    {
        ...
        private void GlobalSettings(bool helpEnabled)
        {
            ...
            m_profile.m_buildTargetDirectory = m_editorUtils.TextField("BuildTargetDirectory", m_profile.m_buildTargetDirectory, helpEnabled);
#if GAIA_INPUT_SYSTEM
            m_profile.m_screenShotKey = (Key)m_editorUtils.EnumPopup("ScreenshotKey", m_profile.m_screenShotKey, helpEnabled);
#endif
