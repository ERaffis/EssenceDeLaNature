...
Shader "Distant Lands/Cozy/Stylized Clouds Ghibli"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 voronoiSmoothId35_g40 = 0;
			...
			float saferPower4_g40 = abs( break2_g40.x );
			float saferPower3_g40 = abs( break2_g40.y );
			float saferPower6_g40 = abs( ( pow( saferPower4_g40 , 2.0 ) + pow( saferPower3_g40 , 2.0 ) ) );
			...
			voroi35_g40 += fade35_g40 * voronoi35_g40( coords35_g40, time35_g40, id35_g40, uv35_g40, 0,voronoiSmoothId35_g40 );
			...
			float2 voronoiSmoothId13_g40 = 0;
			...
			voroi13_g40 += fade13_g40 * voronoi13_g40( coords13_g40, time13_g40, id13_g40, uv13_g40, 0,voronoiSmoothId13_g40 );
			...
			float2 voronoiSmoothId11_g40 = 0;
			...
			voroi11_g40 += fade11_g40 * voronoi11_g40( coords11_g40, time11_g40, id11_g40, uv11_g40, 0,voronoiSmoothId11_g40 );
			...
			float2 voronoiSmoothId35_g38 = 0;
			float2 temp_output_21_0_g38 = CentralUV998;
			float2 break2_g38 = abs( temp_output_21_0_g38 );
			float saferPower4_g38 = abs( break2_g38.x );
			float saferPower3_g38 = abs( break2_g38.y );
			float saferPower6_g38 = abs( ( pow( saferPower4_g38 , 2.0 ) + pow( saferPower3_g38 , 2.0 ) ) );
			...
			voroi35_g38 += fade35_g38 * voronoi35_g38( coords35_g38, time35_g38, id35_g38, uv35_g38, 0,voronoiSmoothId35_g38 );
			...
			float2 voronoiSmoothId13_g38 = 0;
			...
			voroi13_g38 += fade13_g38 * voronoi13_g38( coords13_g38, time13_g38, id13_g38, uv13_g38, 0,voronoiSmoothId13_g38 );
			...
			float2 voronoiSmoothId11_g38 = 0;
			...
			voroi11_g38 += fade11_g38 * voronoi11_g38( coords11_g38, time11_g38, id11_g38, uv11_g38, 0,voronoiSmoothId11_g38 );
			...
			float2 voronoiSmoothId35_g39 = 0;
			float2 temp_output_21_0_g39 = CentralUV998;
			float2 break2_g39 = abs( temp_output_21_0_g39 );
			float saferPower4_g39 = abs( break2_g39.x );
			float saferPower3_g39 = abs( break2_g39.y );
			float saferPower6_g39 = abs( ( pow( saferPower4_g39 , 2.0 ) + pow( saferPower3_g39 , 2.0 ) ) );
			...
			voroi35_g39 += fade35_g39 * voronoi35_g39( coords35_g39, time35_g39, id35_g39, uv35_g39, 0,voronoiSmoothId35_g39 );
			...
			float2 voronoiSmoothId13_g39 = 0;
			...
			voroi13_g39 += fade13_g39 * voronoi13_g39( coords13_g39, time13_g39, id13_g39, uv13_g39, 0,voronoiSmoothId13_g39 );
			...
			float2 voronoiSmoothId11_g39 = 0;
			...
			voroi11_g39 += fade11_g39 * voronoi11_g39( coords11_g39, time11_g39, id11_g39, uv11_g39, 0,voronoiSmoothId11_g39 );
			...
			float2 voronoiSmoothId35_g42 = 0;
			float2 temp_output_21_0_g42 = ShadowUV997;
			float2 break2_g42 = abs( temp_output_21_0_g42 );
			float saferPower4_g42 = abs( break2_g42.x );
			float saferPower3_g42 = abs( break2_g42.y );
			float saferPower6_g42 = abs( ( pow( saferPower4_g42 , 2.0 ) + pow( saferPower3_g42 , 2.0 ) ) );
			...
			voroi35_g42 += fade35_g42 * voronoi35_g42( coords35_g42, time35_g42, id35_g42, uv35_g42, 0,voronoiSmoothId35_g42 );
			...
			float2 voronoiSmoothId13_g42 = 0;
			...
			voroi13_g42 += fade13_g42 * voronoi13_g42( coords13_g42, time13_g42, id13_g42, uv13_g42, 0,voronoiSmoothId13_g42 );
			...
			float2 voronoiSmoothId11_g42 = 0;
			...
			voroi11_g42 += fade11_g42 * voronoi11_g42( coords11_g42, time11_g42, id11_g42, uv11_g42, 0,voronoiSmoothId11_g42 );
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-670.0242,-403.7039;Float;False;True;-1;2;EmptyShaderGUI;0;0;Unlit;Distant Lands/Cozy/Stylized Clouds Ghibli;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Front;0;False;;0;False;;False;0;False;;0;False;;False;0;Transparent;0.5;True;True;-50;False;Transparent;;Transparent;ForwardOnly;12;all;True;True;True;True;0;False;;True;221;False;;255;False;;255;False;;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;2;5;False;;10;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=B2BF8C1045633367ECFA9C56DCC98FBF562039A1