...
Shader "Distant Lands/Cozy/Stylized Sky Desktop"
{
	...
	SubShader
	{
		...
		uniform sampler2D _GalaxyPlacement;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float simpleNoise213 = SimpleNoise( (Pos83*5.0 + mulTime205)*2.0 );
			float StarPlacementPattern217 = saturate( ( min( tex2D( _SkyPatchwork, (Pos83*5.0 + mulTime202) ).r , tex2D( _SkyPatchwork, (rotator203*5.0 + 0.0) ).r ) * simpleNoise213 * (0.2 + (SimpleGradient170 - 0.0) * (0.0 - 0.2) / (1.0 - 0.0)) ) );
			...
			float temp_output_181_0 = min( tex2D( _StarTexture, (panner321*4.0 + mulTime175) ).r , tex2D( _SkyPatchwork, (rotator176*10.0 + 0.0) ).r );
			...
			float mulTime342 = _Time.y * 0.005;
...
Node;AmplifyShaderEditor.Vector3Node;64;-4331.223,404.3474;Inherit;False;Global;CZY_MoonDirection;CZY_MoonDirection;12;0;Create;True;0;0;0;False;0;False;0,0,0;0,0.9455186,-0.3255683;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;49;-4359.506,-458.4658;Inherit;False;Global;CZY_SunDirection;CZY_SunDirection;12;0;Create;True;0;0;0;False;0;False;0,0,0;0.3029479,-0.8901785,-0.3403011;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SamplerNode;79;-1678.882,-1886.035;Inherit;True;Property;_SkyPatchwork;Sky Patchwork;18;0;Create;True;0;0;0;False;0;False;-1;59cb97507f14c1d468e967d73ca67a9b;59cb97507f14c1d468e967d73ca67a9b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMinOpNode;181;767,-2804;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;219;768,-2961;Inherit;False;217;StarPlacementPattern;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;204;3314.346,-2474.76;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;5;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;213;3601.541,-2289.478;Inherit;True;Simple;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScaleAndOffsetNode;178;240,-2688;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;10;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;356;256,-2512;Inherit;False;353;GalaxyPos;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;355;416,-2512;Inherit;True;Property;_GalaxyStars;Galaxy Stars;16;0;Create;True;0;0;0;False;0;False;-1;831ed62fbc9349041bf2404184ed2461;831ed62fbc9349041bf2404184ed2461;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;357;784,-2512;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.2;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=EC8A612A7150A1F4114B9393109D173C8E6A7801